...
export default function ProveedorConfiguracion() {
  ...
  async function save() {
    if (!form.slug.trim()) {
      return setError('El código de acceso no puede estar vacío')
    }
      ...
      <div style={{ maxWidth: 500, display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 4 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 12, color: 'var(--ink-muted)' }}>
                Nombre y código para tus distribuidores
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <input
              className="input"
              placeholder="Mi Tienda Streaming"
          ...
          <PhoneInput
            label="Número WhatsApp de soporte / ventas"
            value={form.whatsapp_support}
            onChange={value =>
              setForm(f => ({ ...f, whatsapp_support: value }))
            }
          />

          <p style={{ fontSize: 11, color: 'var(--ink-faint)', marginTop: -8 }}>
            Cuando un distribuidor haga un pedido a pedido o reporte un problema,
            el sistema usará este número para abrir WhatsApp automáticamente.
          </p>
        ...
        >
          ...
          <div>
            ...
            <p style={{ fontSize: 12, color: 'var(--ink-muted)', lineHeight: 1.6 }}>
              ...
              con tus distribuidores. Ellos se registran en <strong>/register</strong> con
              rol "Distribuidor" e ingresan tu código. Luego tú activas su cuenta desde
              la sección Distribuidores.
            </p>
          </div>
        </div>
      </div>
